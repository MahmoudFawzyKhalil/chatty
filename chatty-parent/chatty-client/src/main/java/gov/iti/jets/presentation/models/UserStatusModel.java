...
public class UserStatusModel {
    ...
    public UserStatusModel(int StatusId, String StatusName){
        this.userStatusId = new SimpleIntegerProperty(StatusId);
        this.userStatusName = new SimpleStringProperty(StatusName);
    }

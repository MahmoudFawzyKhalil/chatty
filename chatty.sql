...
ALTER TABLE invitations
    ADD CONSTRAINT FOREIGN KEY(sender) REFERENCES users(phone_number),
    ADD CONSTRAINT FOREIGN KEY(receiver) REFERENCES users(phone_number),
    ADD CONSTRAINT PRIMARY KEY(sender, receiver),
    ADD CONSTRAINT CHECK (sender != receiver);
